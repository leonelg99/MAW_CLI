...
<p>Para facilitar el control del vehiculo se diseño un software de control mediante pyhton con el cual recibir video, y el envio y recepcion de mensajes.</p>
