...
# Crear etiquetas para los botones 1, 2, 3 y 4
boton_1_label = tk.Label(joystick_frame, text="1", font=("Arial Bold", 20))
boton_1_label.grid(row=0, column=0, padx=10, pady=10)
boton_2_label = tk.Label(joystick_frame, text="2", font=("Arial Bold", 20))
boton_2_label.grid(row=0, column=1, padx=10, pady=10)
boton_3_label = tk.Label(joystick_frame, text="3", font=("Arial Bold", 20))
boton_3_label.grid(row=1, column=0, padx=10, pady=10)
boton_4_label = tk.Label(joystick_frame, text="4", font=("Arial Bold", 20))
boton_4_label.grid(row=1, column=1, padx=10, pady=10)

# Crear una etiqueta para mostrar el texto del joystick
joystick_text_label = tk.Label(joystick_frame, text="", font=("Arial", 12))
joystick_text_label.grid(row=2, column=0, columnspan=2, padx=10, pady=10)
# Empaqueta en el marco
...
def mostrar_joystick():
    ...
    if num_joysticks > 0:
        ...
        for i in range(buttons):
            ...
            if nombre_boton == "1":
                boton_1_label.config(text=f"{nombre_boton}: {estado_boton}")
            elif nombre_boton == "2":
                boton_2_label.config(text=f"{nombre_boton}: {estado_boton}")
            elif nombre_boton == "3":
                boton_3_label.config(text=f"{nombre_boton}: {estado_boton}")
            elif nombre_boton == "4":
                boton_4_label.config(text=f"{nombre_boton}: {estado_boton}")
    ...
    joystick_text_label.config(text=joystick_text)
